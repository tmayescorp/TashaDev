...
{
    wp_register_style( 'bdotcom_bc_general_css', BDOTCOM_BC_CSS_PLUGIN_DIR . '/bdotcom_bc_general.css', '', '1.3' );
    wp_register_style( 'bdotcom_bc_admin_css', BDOTCOM_BC_CSS_PLUGIN_DIR . '/bdotcom_bc_admin.css', '', '1.3' );
}
