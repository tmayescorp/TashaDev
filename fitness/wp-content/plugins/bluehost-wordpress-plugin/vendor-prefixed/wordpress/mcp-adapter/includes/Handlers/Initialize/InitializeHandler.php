...
class InitializeHandler {
	 ...
	 *
	 * @return \Bluehost\Plugin\WP\McpSchema\Common\Protocol\DTO\InitializeResult Response with server capabilities and information.
	 */
	public function handle( string $client_protocol_version ): InitializeResult {
		 ...
		 * @since 0.5.0
		 *
		 * @param \Bluehost\Plugin\WP\McpSchema\Common\Protocol\DTO\InitializeResult $result The initialize result DTO.
