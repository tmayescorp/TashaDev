...
class McpComponentRegistry {
	 ...
	 *
	 * @var array<string, \Bluehost\Plugin\WP\MCP\Domain\Tools\McpTool>
	 */
	 ...
	 *
	 * @var array<string, \Bluehost\Plugin\WP\MCP\Domain\Resources\McpResource>
	 */
	 ...
	 *
	 * @var array<string, \Bluehost\Plugin\WP\MCP\Domain\Prompts\McpPrompt>
	 */
	...
	public function __construct(
		 ...
		 * @param \Bluehost\Plugin\WP\MCP\Core\McpServer $server        The McpServer instance owning the registry.
		 */
	 ...
	 *
	 * @param list<string|\Bluehost\Plugin\WP\MCP\Domain\Tools\McpTool> $tools Array of ability names (strings) or McpTool instances.
	 *
	 * @return void
	 */
	 ...
	 *
	 * @param string|\Bluehost\Plugin\WP\MCP\Domain\Tools\McpTool $tool_item The tool to register.
	 *
	 * @return void
	 */
	private function register_single_tool( $tool_item ): void {
		...
		if ( $tool_item instanceof McpTool ) {
			...
			/** @var \Bluehost\Plugin\WP\McpSchema\Server\Tools\DTO\Tool $tool_dto */
	 ...
	 *
	 * @param \Bluehost\Plugin\WP\MCP\Domain\Tools\McpTool $mcp_tool McpTool instance.
	 *
	 * @return void
	 * @since 0.3.0
	 *
	 ...
	 *
	 * @param list<string|\Bluehost\Plugin\WP\MCP\Domain\Resources\McpResource> $resources Array of ability names or McpResource instances.
	 *
	 * @return void
	 */
	 ...
	 *
	 * @param string|\Bluehost\Plugin\WP\MCP\Domain\Resources\McpResource $resource_item The resource to register.
	 *
	 * @return void
	 */
	private function register_single_resource( $resource_item ): void {
		...
		if ( $resource_item instanceof McpResource ) {
			...
			/** @var \Bluehost\Plugin\WP\McpSchema\Server\Resources\DTO\Resource $resource_dto */
	 ...
	 *
	 * @param \Bluehost\Plugin\WP\MCP\Domain\Resources\McpResource $mcp_resource McpResource instance.
	 *
	 ...
	 *
	 * @param list<string|\Bluehost\Plugin\WP\MCP\Domain\Prompts\McpPrompt|\Bluehost\Plugin\WP\MCP\Domain\Prompts\Contracts\McpPromptBuilderInterface> $prompts Array of prompts to register.
	 *
	 * @return void
	 */
	 ...
	 *
	 * @param string|\Bluehost\Plugin\WP\MCP\Domain\Prompts\McpPrompt|\Bluehost\Plugin\WP\MCP\Domain\Prompts\Contracts\McpPromptBuilderInterface $prompt_item The prompt to register.
	 *
	 * @return void
	 */
	private function register_single_prompt( $prompt_item ): void {
		...
		if ( $prompt_item instanceof McpPrompt ) {
			...
			/** @var \Bluehost\Plugin\WP\McpSchema\Server\Prompts\DTO\Prompt $prompt_dto */
	 ...
	 *
	 * @param \Bluehost\Plugin\WP\MCP\Domain\Prompts\McpPrompt $mcp_prompt McpPrompt instance.
	 *
	 * @return void
	 * @since 0.3.0
	 *
	...
	private function add_mcp_prompt( McpPrompt $mcp_prompt ): void {
		/** @var \Bluehost\Plugin\WP\McpSchema\Server\Prompts\DTO\Prompt $prompt */
	 ...
	 *
	 * @param \Bluehost\Plugin\WP\MCP\Domain\Prompts\Contracts\McpPromptBuilderInterface $builder The builder instance.
	 *
	 * @return void
	 */
	 ...
	 *
	 * @return array<string, \Bluehost\Plugin\WP\McpSchema\Server\Tools\DTO\Tool>
	 */
	 ...
	 *
	 * @return array<string, \Bluehost\Plugin\WP\McpSchema\Server\Resources\DTO\Resource>
	 */
	 ...
	 *
	 * @return array<string, \Bluehost\Plugin\WP\McpSchema\Server\Prompts\DTO\Prompt>
	 */
	 ...
	 * @param string $prompt_name Prompt name.
	 *
	 * @return \Bluehost\Plugin\WP\MCP\Domain\Prompts\Contracts\McpPromptBuilderInterface|null
	 */
