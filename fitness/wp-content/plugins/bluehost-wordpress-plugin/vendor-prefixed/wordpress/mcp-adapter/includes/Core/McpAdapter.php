...
final class McpAdapter
{
    ...
    public function init(): void
    {
         ...
         * @since 0.1.0
         *
         * @param \Bluehost\Plugin\WP\MCP\Core\McpAdapter $adapter The MCP Adapter singleton instance.
         */
     ...
     * @param array<class-string<\Bluehost\Plugin\WP\MCP\Transport\Contracts\McpTransportInterface>> $mcp_transports Array of MCP transport class names to initialize.
     * @param class-string<\Bluehost\Plugin\WP\MCP\Infrastructure\ErrorHandling\Contracts\McpErrorHandlerInterface>|null $error_handler The error handler class name. If null, NullMcpErrorHandler will be used.
     * @param class-string<\Bluehost\Plugin\WP\MCP\Infrastructure\Observability\Contracts\McpObservabilityHandlerInterface>|null $observability_handler The observability handler class name. If null, NullMcpObservabilityHandler will be used.
