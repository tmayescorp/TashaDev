...
class PromptsHandler {
	 ...
	 *
	 * @return \Bluehost\Plugin\WP\McpSchema\Server\Prompts\DTO\ListPromptsResult Response with prompts list DTO.
	 */
	public function list_prompts(): ListPromptsResult {
		 ...
		 * @since 0.5.0
		 *
		 * @param array<\Bluehost\Plugin\WP\McpSchema\Server\Prompts\DTO\Prompt> $prompts Array of Prompt DTOs.
		 * @param \Bluehost\Plugin\WP\MCP\Core\McpServer                         $server  The MCP server instance.
		 */
	 ...
	 *
	 * @return \Bluehost\Plugin\WP\McpSchema\Server\Prompts\DTO\GetPromptResult|\Bluehost\Plugin\WP\McpSchema\Common\JsonRpc\DTO\JSONRPCErrorResponse Response with prompt execution results or error.
	 */
	public function get_prompt( array $params, $request_id = 0 ) {
		...
		try {
			 ...
			 * @param \Bluehost\Plugin\WP\MCP\Domain\Prompts\McpPrompt   $mcp_prompt  The MCP prompt instance.
			 * @param \Bluehost\Plugin\WP\MCP\Core\McpServer             $server      The MCP server instance.
			 */
	 ...
	 * @param \Bluehost\Plugin\WP\McpSchema\Server\Prompts\DTO\Prompt $prompt      The prompt DTO for description fallback.
	 * @param string                                $prompt_name Prompt name for logging.
	 *
	 * @return \Bluehost\Plugin\WP\McpSchema\Server\Prompts\DTO\GetPromptResult
	 */
	 ...
	 * @param \Bluehost\Plugin\WP\McpSchema\Server\Prompts\DTO\Prompt $prompt      The prompt DTO.
	 * @param string                                $prompt_name Prompt name for logging.
	 *
	 * @return \Bluehost\Plugin\WP\McpSchema\Server\Prompts\DTO\GetPromptResult
	 */
	 ...
	 * @param string $prompt_name Prompt name for logging.
	 *
	 * @return \Bluehost\Plugin\WP\McpSchema\Server\Prompts\DTO\PromptMessage
	 */
