...
class McpErrorFactory {
	 ...
	 *
	 * @return \Bluehost\Plugin\WP\McpSchema\Common\JsonRpc\DTO\JSONRPCErrorResponse
	 */
	 ...
	 * @param mixed|null $data Optional additional error data.
	 *
	 * @return \Bluehost\Plugin\WP\McpSchema\Common\JsonRpc\DTO\Error
	 */
	 ...
	 *
	 * @param \Bluehost\Plugin\WP\McpSchema\Common\JsonRpc\DTO\JSONRPCErrorResponse|array $error_response The MCP error response (DTO or array).
	 *
	 ...
	 *
	 * @return true|\Bluehost\Plugin\WP\McpSchema\Common\JsonRpc\DTO\JSONRPCErrorResponse Returns true if valid, or JSONRPCErrorResponse DTO if invalid.
	 */
