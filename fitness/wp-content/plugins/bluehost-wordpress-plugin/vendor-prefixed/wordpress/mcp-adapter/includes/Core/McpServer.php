...
class McpServer {
	 ...
	 * @param array<class-string<\Bluehost\Plugin\WP\MCP\Transport\Contracts\McpTransportInterface>> $mcp_transports Array of MCP transport class names to initialize (e.g., [McpRestTransport::class]).
	...
	public function __construct(
		 ...
		 * @param \Bluehost\Plugin\WP\MCP\Core\McpServer $server    The McpServer instance being constructed.
		 */
	 ...
	 * @param array<class-string<\Bluehost\Plugin\WP\MCP\Transport\Contracts\McpTransportInterface>> $mcp_transports Transport classes to initialize.
	 *
	 * @throws \Exception
	 */
	 ...
	 * @since 0.5.0
	 *
	 * @return \Bluehost\Plugin\WP\MCP\Infrastructure\ErrorHandling\Contracts\McpErrorHandlerInterface
	 */
	 ...
	 *
	 * @return \Bluehost\Plugin\WP\McpSchema\Server\Prompts\DTO\Prompt|null
	 */
