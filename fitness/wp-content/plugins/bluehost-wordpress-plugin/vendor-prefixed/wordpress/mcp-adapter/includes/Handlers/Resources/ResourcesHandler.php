...
class ResourcesHandler {
	 ...
	 *
	 * @return \Bluehost\Plugin\WP\McpSchema\Server\Resources\DTO\ListResourcesResult Response with resources list.
	 */
	public function list_resources(): ListResourcesResult {
		 ...
		 * @since 0.5.0
		 *
		 * @param array<\Bluehost\Plugin\WP\McpSchema\Server\Resources\DTO\Resource> $resources Array of Resource DTOs.
	 ...
	 *
	 * @return \Bluehost\Plugin\WP\McpSchema\Server\Resources\DTO\ReadResourceResult|\Bluehost\Plugin\WP\McpSchema\Common\JsonRpc\DTO\JSONRPCErrorResponse
	 */
	public function read_resource( array $params, $request_id = 0 ) {
		...
		/** @var \Bluehost\Plugin\WP\McpSchema\Server\Resources\DTO\Resource $resource */
		...
		try {
			 ...
			 * @param \Bluehost\Plugin\WP\MCP\Domain\Resources\McpResource $mcp_resource The MCP resource instance.
			 * @param \Bluehost\Plugin\WP\MCP\Core\McpServer               $server       The MCP server instance.
			 */
	 ...
	 * @param string $uri The resource URI.
	 *
	 * @return array<\Bluehost\Plugin\WP\McpSchema\Common\Protocol\DTO\TextResourceContents|\Bluehost\Plugin\WP\McpSchema\Common\Protocol\DTO\BlobResourceContents>
	 */
