...
class CompleteRequest extends JSONRPCRequest implements ClientRequestInterface
{
    ...
    /**
     * @var \Bluehost\Plugin\WP\McpSchema\Server\Core\DTO\CompleteRequestParams
     */
     ...
     * @param \Bluehost\Plugin\WP\McpSchema\Server\Core\DTO\CompleteRequestParams $params @since 2024-11-05
     */
     ...
     *     params: array<string, mixed>|\Bluehost\Plugin\WP\McpSchema\Server\Core\DTO\CompleteRequestParams
     * } $data
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var \Bluehost\Plugin\WP\McpSchema\Server\Core\DTO\CompleteRequestParams $params */
    ...
    /**
     * @return \Bluehost\Plugin\WP\McpSchema\Server\Core\DTO\CompleteRequestParams
     */
