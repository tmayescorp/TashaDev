...
class ElicitRequestFormParams extends TaskAugmentedRequestParams implements ElicitRequestParamsInterface
{
     ...
     * @since 2025-11-25
     *
     * @var \Bluehost\Plugin\WP\McpSchema\Client\Elicitation\DTO\ElicitRequestFormParamsRequestedSchema
     */
    protected ElicitRequestFormParamsRequestedSchema $requestedSchema;

    /**
     * @param string $message @since 2025-11-25
     * @param \Bluehost\Plugin\WP\McpSchema\Client\Elicitation\DTO\ElicitRequestFormParamsRequestedSchema $requestedSchema @since 2025-11-25
     ...
     *     mode?: 'form'|null,
     *     message: string,
     *     requestedSchema: array<string, mixed>|\Bluehost\Plugin\WP\McpSchema\Client\Elicitation\DTO\ElicitRequestFormParamsRequestedSchema
     * } $data
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var \Bluehost\Plugin\WP\McpSchema\Client\Elicitation\DTO\ElicitRequestFormParamsRequestedSchema $requestedSchema */
    ...
    /**
     * @return \Bluehost\Plugin\WP\McpSchema\Client\Elicitation\DTO\ElicitRequestFormParamsRequestedSchema
     */
