...
class ListTasksResult extends PaginatedResult implements ClientResultInterface, ServerResultInterface
{
     ...
     * @since 2025-11-25
     *
     * @var array<\Bluehost\Plugin\WP\McpSchema\Client\Tasks\DTO\Task>
     */
    protected array $tasks;

    /**
     * @param array<\Bluehost\Plugin\WP\McpSchema\Client\Tasks\DTO\Task> $tasks @since 2025-11-25
     ...
     *     tasks: array<array<string, mixed>|\Bluehost\Plugin\WP\McpSchema\Client\Tasks\DTO\Task>
     * } $data
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var array<\Bluehost\Plugin\WP\McpSchema\Client\Tasks\DTO\Task> $tasks */
        $tasks = array_map(
    ...
    /**
     * @return array<\Bluehost\Plugin\WP\McpSchema\Client\Tasks\DTO\Task>
     */
