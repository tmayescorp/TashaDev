...
class ListToolsResult extends PaginatedResult implements ServerResultInterface
{
     ...
     * @since 2024-11-05
     *
     * @var array<\Bluehost\Plugin\WP\McpSchema\Server\Tools\DTO\Tool>
     */
    protected array $tools;

    /**
     * @param array<\Bluehost\Plugin\WP\McpSchema\Server\Tools\DTO\Tool> $tools @since 2024-11-05
     ...
     *     tools: array<array<string, mixed>|\Bluehost\Plugin\WP\McpSchema\Server\Tools\DTO\Tool>
     * } $data
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var array<\Bluehost\Plugin\WP\McpSchema\Server\Tools\DTO\Tool> $tools */
        $tools = array_map(
    ...
    /**
     * @return array<\Bluehost\Plugin\WP\McpSchema\Server\Tools\DTO\Tool>
     */
