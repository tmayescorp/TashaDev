...
class ListResourcesResult extends PaginatedResult implements ServerResultInterface
{
     ...
     * @since 2024-11-05
     *
     * @var array<\Bluehost\Plugin\WP\McpSchema\Server\Resources\DTO\Resource>
     */
    protected array $resources;

    /**
     * @param array<\Bluehost\Plugin\WP\McpSchema\Server\Resources\DTO\Resource> $resources @since 2024-11-05
     ...
     *     resources: array<array<string, mixed>|\Bluehost\Plugin\WP\McpSchema\Server\Resources\DTO\Resource>
     * } $data
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var array<\Bluehost\Plugin\WP\McpSchema\Server\Resources\DTO\Resource> $resources */
        $resources = array_map(
    ...
    /**
     * @return array<\Bluehost\Plugin\WP\McpSchema\Server\Resources\DTO\Resource>
     */
