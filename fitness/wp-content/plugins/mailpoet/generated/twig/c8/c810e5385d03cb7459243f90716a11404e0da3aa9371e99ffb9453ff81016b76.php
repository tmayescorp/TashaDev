...
<script type=\"text/javascript\">
  var
    ...
    mailpoetSegments = JSON.parse(\"";
        ...
        yield "\"),
    mailpoet_import_custom_fields_date_types = ";
        // line 35
        yield $this->extensions['MailPoet\Twig\Functions']->jsonEncode(($context["custom_fields_date_types"] ?? null));
        yield ",
    mailpoet_import_custom_fields_date_formats = ";
        // line 36
        yield $this->extensions['MailPoet\Twig\Functions']->jsonEncode(($context["date_formats"] ?? null));
        yield ",
    mailpoet_custom_fields_api = ";
        // line 37
        yield $this->extensions['MailPoet\Twig\Functions']->jsonEncode(($context["custom_fields_api"] ?? null));
        yield ";
</script>

";
        // line 40
        yield $this->extensions['MailPoet\Twig\I18n']->localize(["noMailChimpLists" => $this->extensions['MailPoet\Twig\I18n']->translate("No active lists found"), "serverError" => $this->extensions['MailPoet\Twig\I18n']->translate("Server error:"), "select" => $this->extensions['MailPoet\Twig\I18n']->translate("Select", "Form input type"), "wrongFileFormat" => $this->extensions['MailPoet\Twig\I18n']->translate("Only comma-separated (CSV) file formats are supported."), "maxPostSizeNotice" => MailPoetVendor\Twig\Extension\CoreExtension::replace($this->extensions['MailPoet\Twig\I18n']->translate("Your CSV is over %s and is too big to process. Please split the file into two or more sections."), ["%s" =>         // line 45
...
";
    ...
    {
        return array (  131 => 145,  129 => 45,  128 => 40,  122 => 37,  118 => 36,  114 => 35,  110 => 34,  106 => 33,  102 => 32,  97 => 30,  93 => 29,  89 => 28,  82 => 23,  80 => 22,  73 => 18,  59 => 7,  54 => 4,  50 => 3,  45 => 2,  43 => 1,  36 => 2,);
    }
