...
function wilcitySidebarPriceRange($aArgs)
{
    ...
    $maximumPrice = apply_filters('wilcity/price-range/price-format-number',
        GetSettings::getPostMeta($post->ID, 'maximum_price'));
    $minimumPrice =  apply_filters('wilcity/price-range/price-format-number',
        GetSettings::getPostMeta($post->ID, 'minimum_price'));
    ...
    <div class="<?php echo esc_attr(apply_filters('wilcity/filter/class-prefix',
      'wilcity-sidebar-item-price-range content-box_module__333d9')); ?>">
        <?php wilcityRenderSidebarHeader($aAtts['name'], $aAtts['icon']); ?>
        <div class="<?php echo esc_attr(apply_filters('wilcity/filter/class-prefix',
          'content-box_body__3tSRB wilcity-price-range-'.esc_attr($range))); ?>">
                    ...
                    <?php if (class_exists('NumberFormatter')) : ?>
                        <div class="price-range_range__19Fut color-primary">
                            <div class="price-range_from__3iV-6">
                                <?php echo Price::renderPrice($minimumPrice); ?>
                            </div>
                            ...
                            <?php if (!empty($maximumPrice)) : ?>
                                ...
                                <div class="price-range_to__2Tf3W">
                                    <?php echo Price::renderPrice($maximumPrice); ?>
                                </div>
                            <?php endif; ?>
                        </div>
                    <?php else :
                        ...
                        ?>
                        <div class="price-range_range__19Fut color-primary">
                            <div class="price-range_from__3iV-6"><sup
                                        class="price-range_supSig__1pMDY <?php echo esc_attr($currencyPos); ?>"><?php echo esc_attr($currencySymbol); ?></sup><?php echo esc_html($minimumPrice); ?>
                            </div>
                            
                            <?php if (!empty($maximumPrice)) : ?>
                                <div class="price-range_arrow__3LnNe"><i class="la la-arrow-right"></i></div>
                                <div class="price-range_to__2Tf3W"><sup
                                            class="price-range_supSig__1pMDY <?php echo esc_attr($currencyPos); ?>"><?php echo esc_attr($currencySymbol); ?></sup><?php echo esc_html($maximumPrice); ?>
                                </div>
                            <?php endif; ?>
