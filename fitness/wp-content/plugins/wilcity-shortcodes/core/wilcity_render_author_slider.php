...
if ( !function_exists('wilcity_render_author_slider') ){
	function wilcity_render_author_slider($aAtts){
		$aRoleIn = is_array($aAtts['role__in']) ? $aAtts['role__in'] : explode(',', $aAtts['role__in']);
		...
		?>
		<div id="<?php echo esc_attr(uniqid(apply_filters('wilcity/filter/id-prefix', 'wilcity-slider-'))); ?>" class="swiper__module swiper-container swiper--button-pill swiper--button-abs-outer swiper--button-mobile-disable" data-options='{"slidesPerView":1,"spaceBetween":30, "breakpoints":{"640":{"slidesPerView": 1, "spaceBetween": 10}, "992": {"slidesPerView": 3, "spaceBetween": 10}, "1200": {"slidesPerView": 4, "spaceBetween": 20}, "1400":{"slidesPerView": 4, "spaceBetween": 30}, "1600": {"slidesPerView": 5, "spaceBetween": 30}}}'>
