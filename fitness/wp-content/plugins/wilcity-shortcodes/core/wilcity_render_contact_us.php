                ...
                foreach ($atts['contact_info'] as $oContactInfo):
                    ...
                    <div class="icon-box-1_module__uyg5F one-text-ellipsis mt-20 mt-sm-15">
                        <div class="icon-box-1_block1__bJ25J">
                            ...
                            <a href="mailto:<?php echo esc_attr($oContactInfo->link); ?>"
                               target="<?php echo esc_attr($oContactInfo->target); ?>">
                                <?php elseif ($oContactInfo->type == 'phone') : ?>
                                <a href="tel:<?php echo esc_attr($oContactInfo->link); ?>"
                                   target="<?php echo esc_attr($oContactInfo->target); ?>">
                                    <?php else: ?>
                                    <a href="<?php echo esc_attr($oContactInfo->link); ?>"
                                       target="<?php echo esc_attr($oContactInfo->target); ?>">
                                        <?php endif; ?>
            ...
            <header class="content-box_header__xPnGx clearfix">
                <div class="wil-float-left">
                    <h4 class="content-box_title__1gBHS"><i
                                class="la la-paper-plane"></i><span><?php echo esc_html($atts['contact_form_heading']); ?></span>
                    </h4>
                </div>
            </header>
            <div class="content-box_body__3tSRB">
