...
function wilcityRenderRestaurantListings($aAtts)
{
    ...
    $aArgs        = $aArgs = SCHelpers::parseArgs($aAtts);
        ...
        if ($aAtts['toggle_viewmore'] == 'enable'):
            ...
            <div class="col-md-12 col-lg-12">
                <div class="wil-text-center">
                    <a class="wil-btn wil-btn--primary wil-btn--round wil-btn--md"
                       href="<?php echo esc_url(SCHelpers::getViewAllUrl($aAtts)); ?>">
                        <i class="<?php echo esc_attr($aAtts['viewmore_icon']); ?>"></i> <?php echo esc_html($aAtts['viewmore_btn_name']); ?>
                    </a>
                </div>
            </div>
        <?php endif; ?>
