...
$title      = $tabs_position = $nav_item_style = $interval =
$open_mouseover = $class = $navigation = $auto_play = $auto_height = $auto_play = $tab_nav_class = $title_slider = '';
$speed      = 4500;
$pagination = 'yes';
...
$css_class = array_merge($css_class, ['kc_tabs', 'group']);
...
$aWrapperClass = ['wilTab_module__jlr12 wil-tab'];
...
global $wilcityHasActivatedTab, $wilcityHasTabContentActive, $wilTabsAtts;
