...
class ListingPromotionOnBlogSidebar extends \WP_Widget {
	public $aDef = ['title'=>'', 'post_type' => 'listing', 'orderby'=>'menu_order', 'order'=>'DESC', 'number_of_posts'=>4, 'taxonomy'=>'', 'style'=>'list'];
	...
	public function widget( $aAtts, $aInstance ) {
		...
		$aMetaKey = GetSettings::getPromotionKeyByPosition('blog_sidebar', true);
        if ( empty($aMetaKey) ){
		    return '';
		}
		$aArgs = [
