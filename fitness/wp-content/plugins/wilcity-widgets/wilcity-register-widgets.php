...
{
    wp_register_script('wilcity-widget-mailchimp', plugin_dir_url(__FILE__).'front-end/js/mailchimp.js', ['jquery'],
      '1.0', true);
}
...
{
    if ($hook != 'widgets.php' && (!isset($_GET['action']) || $_GET['action'] !== 'elementor')) {
        return false;
    }
    wp_enqueue_media();
    wp_enqueue_script('wilokeWidgetUploadPhoto', plugin_dir_url(__FILE__).'assets/js/widgetUploadImg.js', ['jquery'],
      '1.0', true);
