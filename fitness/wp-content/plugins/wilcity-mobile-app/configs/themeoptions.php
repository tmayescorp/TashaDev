<?php
return apply_filters('wilcity/filter/wilcity-mobile-app/configs/themeoptions', [
	...
	'fields'           => [
		...
		[
			'id'          => 'app_google_settimeout',
			'type'        => 'text',
			'title'       => 'Set timeout',
			'description' => 'The number of milliseconds to wait before AdMob show up',
			'default'     => 1000,
			'required'    => ['app_google_fullwidth_admob_type', '=', 'interstitial'],
		],
		[
		...
		[
			...
			'title'  => 'App Update Announcement',
			'type'   => 'section',
			'indent' => true
		],
		[
			'id'          => 'app_current_version',
			'type'        => 'text',
			'title'       => 'Current Version',
			'default'     => '',
			'description' => 'If a Customer is using an old version, a popup will be appeared to notify about a new update'
		],
		[
			'id'      => 'app_update_description',
			'type'    => 'text',
			'title'   => 'App update notification',
			'default' => 'Wilcity App %s is available already, please upgrade to this version to get better security and performance.'
		],
		[
			'id'      => 'app_update_read_more',
			'type'    => 'textarea',
			'title'   => 'Read more description',
			'default' => 'Click to get more information about this update',
		],
		[
			'id'          => 'app_appstore_url',
			'type'        => 'textarea',
			'title'       => 'Your App URL on App Store',
			'default'     => '',
			'description' => ''
		],
		[
			'id'          => 'app_chplay_url',
			'type'        => 'textarea',
			'title'       => 'Your App URL on CHPlay',
			'default'     => '',
			'description' => ''
		],
		[
			'id'     => 'app_update_notification_close',
			'title'  => '',
			'type'   => 'section',
			'indent' => false
		]
