...
class Statistic
{
    ...
    {
        add_filter('wilcity/mobile/sidebar/statistics', [$this, 'render']);
    }
    ...
    public function render($post)
    {
        ...
        return json_encode([
          ...
          [
            'name'  => $reviews > 1 ? esc_html__('Reviews', WILCITY_SC_DOMAIN) :
              esc_html__('Reviews', WILCITY_SC_DOMAIN),
            'count' => $reviews,
            'key'   => 'reviews'
          ],
          [
            'name'  => $favorites > 1 ? esc_html__('Favorites', WILCITY_SC_DOMAIN) :
              esc_html__('Favorite', WILCITY_SC_DOMAIN),
            'count' => $favorites,
            'key'   => 'favorites'
          ],
          [
