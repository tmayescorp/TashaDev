...
class WooCommerceController
{
	...
	protected $cartItemsKey    = 'wilcity_my_cart_items';
	...
	protected function getCartItemsKey($isFocus = false)
	{
	...
	{
		$aCartItems = $this->getCartItemsKey($isFocus);
	...
	protected function getMyCartSkeleton($userID)
	{
		...
		$aCartItems = get_user_meta($userID, $this->cartItemsKey, true);
