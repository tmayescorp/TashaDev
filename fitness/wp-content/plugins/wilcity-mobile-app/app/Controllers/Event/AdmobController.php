...
class AdmobController
{
    ...
    {
        add_filter('wilcity/wilcity-mobile-app/before-save-homepage-sections', [$this, 'addAdmobToTopOfHomepage']);
        add_filter('wilcity/wilcity-mobile-app/filter/get-listings', [$this, 'addAdmobToTopOfTermPage']);
        add_filter('wilcity/wilcity-mobile-app/filter/listing-detail', [$this, 'addAdmobToTopSingleListingPage'], 10, 3);
    }
    ...
    public function addAdmobToTopOfHomepage($aSettings)
    {
        if (!$this->hasAdmob($aSettings['aSectionKeys'])) {
            ...
            if (!empty($aAdmob)) {
                ...
                $aSettings['aSectionKeys'] = array_merge([
                  $id => 'GOOGLE_ADMOB'
