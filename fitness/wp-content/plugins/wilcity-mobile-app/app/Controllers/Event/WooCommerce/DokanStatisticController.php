...
class DokanStatisticController extends WooCommerceController
{
	public function __construct()
	{
		add_action('rest_api_init', function () {
			...
			register_rest_route(WILOKE_PREFIX . '/' . WILOKE_MOBILE_REST_VERSION, 'dokan/statistic', [
				[
					'methods'             => \WP_REST_Server::READABLE,
					'callback'            => [$this, 'getStatistic'],
					'permission_callback' => '__return_true'
			...
			register_rest_route(WILOKE_PREFIX . '/' . WILOKE_MOBILE_REST_VERSION, 'me/dokan/statistic', [
				[
					'methods'             => \WP_REST_Server::READABLE,
					'callback'            => [$this, 'getStatistic'],
					'permission_callback' => '__return_true'
	...
	public function getStatistic(\WP_REST_Request $oRequest)
	{
		...
		return [
			...
			'oResults' => [
				...
				'oProduct' => [
					'heading' => wilcityAppGetLanguageFiles('Products'),
					'aItems'  => [
						[
							'name'  => wilcityAppGetLanguageFiles('totalLabel'),
