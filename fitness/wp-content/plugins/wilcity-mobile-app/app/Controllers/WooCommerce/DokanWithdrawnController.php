...
class DokanWithdrawnController extends WooCommerceController
{
	public function __construct()
	{
		add_action('rest_api_init', function () {
			register_rest_route(WILOKE_PREFIX . '/' . WILOKE_MOBILE_REST_VERSION, 'dokan/withdrawn', [
				[
			...
			register_rest_route(WILOKE_PREFIX . '/' . WILOKE_MOBILE_REST_VERSION, 'me/dokan/withdrawn', [
				[
					'methods'             => \WP_REST_Server::READABLE,
					'callback'            => [$this, 'getWithdrawn'],
					'permission_callback' => '__return_true'
			...
			register_rest_route(WILOKE_PREFIX . '/' . WILOKE_MOBILE_REST_VERSION, 'dokan/withdrawn/status', [
				[
					'methods'             => \WP_REST_Server::READABLE,
			...
			register_rest_route(WILOKE_PREFIX . '/' . WILOKE_MOBILE_REST_VERSION, 'me/dokan/withdrawn/status', [
				[
					'methods'             => \WP_REST_Server::READABLE,
					'callback'            => [$this, 'getWithdrawStatus'],
					'permission_callback' => '__return_true'
			...
			register_rest_route(WILOKE_PREFIX . '/' . WILOKE_MOBILE_REST_VERSION, 'dokan/withdrawn/pending', [
				[
					'methods'             => \WP_REST_Server::READABLE,
			...
			register_rest_route(WILOKE_PREFIX . '/' . WILOKE_MOBILE_REST_VERSION, 'me/dokan/withdrawn/pending', [
				[
					'methods'             => \WP_REST_Server::READABLE,
					'callback'            => [$this, 'getPendingRequest'],
					'permission_callback' => '__return_true'
			...
			register_rest_route(WILOKE_PREFIX . '/' . WILOKE_MOBILE_REST_VERSION, 'dokan/withdrawn/approved', [
				[
					'methods'             => \WP_REST_Server::READABLE,
			...
			register_rest_route(WILOKE_PREFIX . '/' . WILOKE_MOBILE_REST_VERSION, 'me/dokan/withdrawn/approved', [
				[
					'methods'             => \WP_REST_Server::READABLE,
					'callback'            => [$this, 'getApprovedRequest'],
					'permission_callback' => '__return_true'
			...
			register_rest_route(WILOKE_PREFIX . '/' . WILOKE_MOBILE_REST_VERSION, 'dokan/withdrawn/cancelled', [
				[
					'methods'             => \WP_REST_Server::READABLE,
			...
			register_rest_route(WILOKE_PREFIX . '/' . WILOKE_MOBILE_REST_VERSION, 'me/dokan/withdrawn/cancelled', [
				[
					'methods'             => \WP_REST_Server::READABLE,
					'callback'            => [$this, 'getCancelledRequest'],
					'permission_callback' => '__return_true'
			...
			register_rest_route(WILOKE_PREFIX . '/' . WILOKE_MOBILE_REST_VERSION, 'dokan/withdrawn/request', [
				[
					'methods'             => \WP_REST_Server::READABLE,
			...
			register_rest_route(WILOKE_PREFIX . '/' . WILOKE_MOBILE_REST_VERSION, 'me/dokan/withdrawn/request', [
				[
					'methods'             => \WP_REST_Server::READABLE,
					'callback'            => [$this, 'getWithdrawForm'],
					'permission_callback' => '__return_true'
			...
			register_rest_route(
				...
				'dokan/withdrawn/request/(?P<id>\d+)',
				[
					[
			...
			register_rest_route(
				WILOKE_PREFIX . '/' . WILOKE_MOBILE_REST_VERSION,
				'me/dokan/withdrawn/request/(?P<id>\d+)',
				[
					[
						'methods'             => \WP_REST_Server::DELETABLE,
						'callback'            => [$this, 'cancelledWithdrawn'],
