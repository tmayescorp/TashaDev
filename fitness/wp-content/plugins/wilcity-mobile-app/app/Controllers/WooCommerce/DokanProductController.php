...
class DokanProductController extends WooCommerceController
{
	public function __construct()
	{
		add_action('rest_api_init', function () {
			register_rest_route(WILOKE_PREFIX . '/' . WILOKE_MOBILE_REST_VERSION, 'dokan/products', [
				[
			...
			register_rest_route(WILOKE_PREFIX . '/' . WILOKE_MOBILE_REST_VERSION, 'me/dokan/products', [
				[
					'methods'             => \WP_REST_Server::READABLE,
					'callback'            => [$this, 'getProducts'],
					'permission_callback' => '__return_true'
			...
			register_rest_route(WILOKE_PREFIX . '/' . WILOKE_MOBILE_REST_VERSION, 'dokan/products/(?P<id>\d+)', [
				[
					'methods'             => \WP_REST_Server::READABLE,
			...
			register_rest_route(WILOKE_PREFIX . '/' . WILOKE_MOBILE_REST_VERSION, 'me/dokan/products/(?P<id>\d+)', [
				[
					'methods'             => \WP_REST_Server::READABLE,
					'callback'            => [$this, 'deleteProduct'],
					'permission_callback' => '__return_true'
