...
class BookingComController extends Controller
{
    ...
    {
        add_action('wilcity/deleted/listing', [$this, 'deleteRelatedBookingComCreator']);
        add_action('after_delete_post', [$this, 'updateBookingComCreatorDependsOnListingStatus'], 10, 1);
        add_action('wp_enqueue_scripts', [$this, 'printBannerSettings']);
    }
    ...
    public function printBannerSettings()
    {
        ...
        $mceButton =
            (!empty($mceButton) && ($mceButton == 'yes' || $mceButton == 1 || $mceButton == 'on')) ? true : false;
        ...
        $style .= '#bdotcom_bc_mbe_banner_'.$this->bookingComID.' .bdotcom_bc_copy_wrapper .bdotcom_bc_copy,
                 ...
                 #bdotcom_bc_mbe_banner_'.$this->bookingComID.
                  ' .bdotcom_bc_copy_wrapper .bdotcom_bc_copy div { color: '.$bcCopyColor.';}';
