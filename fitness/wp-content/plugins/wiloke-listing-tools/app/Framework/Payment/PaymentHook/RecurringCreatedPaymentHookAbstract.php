 ...
 */
abstract class RecurringCreatedPaymentHookAbstract
{
    /**
    ...
    public function setupSuccessArgs()
    {
        return $this->oPaymentInterface->oReceipt->getPaymentData([
            ...
            'category'           => Session::getSession(wilokeListingToolsRepository()->get('payment:category'),
                false),
            'paymentID'          => $this->oPaymentInterface->paymentID,
            'trialPeriodDays'    => $this->oPaymentInterface->oReceipt->getTrialPeriod(),
            'regularPeriodDays'  => $this->oPaymentInterface->oReceipt->getRegularPeriod()
        ]);
    }
