...
class DirectBankTransferRecurringPrepareInvoiceFormat extends RecurringPaymentPrepareInvoiceFormatAbstract implements
    PrePareInvoiceFormatInterface
{
    ...
    {
        if ($this->oDirectBankTransferWebhook->isTrial) {
            $this->aParams['total'] = 0;
        } else {
