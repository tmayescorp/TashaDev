...
class RegisterSubmenuQuickSearchForm
{
    ...
    public $aPostTypeSettings = [];

    public function __construct()
    {
        add_action('admin_menu', [$this, 'register']);
        add_action('admin_enqueue_scripts', [$this, 'enqueueScripts']);
        add_action('wp_ajax_wiloke_save_quick_search_form', [$this, 'saveSettings']);
        add_action('wp_insert_post', [$this, 'updateCache'], 10, 2);
        add_action('post_updated', [$this, 'updateCache'], 10, 2);
        add_action('edited_listing_cat', [$this, 'updateTerm'], 10, 1);
        add_action('delete_listing_cat', [$this, 'deleteTerm'], 10, 1);
        add_action('created_listing_cat', [$this, 'updateTerm'], 10, 1);
        add_action('before_delete_post', [$this, 'deletePost'], 10, 1);
        add_action('wilcity/wilcity-import/successfully', [$this, 'setDefaultSettings']);
    }
    ...
    {
        $aOptions = GetSettings::getOptions('quick_search_form_settings', true, true);
    ...
    {
        SetSettings::setOptions('quick_search_form_settings', [
    ...
    public function saveSettings()
    {
        ...
        if ($_POST['page'] == 1) {
            SetSettings::setOptions('quick_search_form_settings', $aSettings, true);
    ...
    public function enqueueScripts($hook)
    {
        ...
        wp_enqueue_script('wiloke-quick-search-form',
            WILOKE_LISTING_TOOL_URL.'admin/source/js/quick-search-form-script.js', ['jquery'],
            WILOKE_LISTING_TOOL_VERSION, true);

        $aValues   = GetSettings::getOptions('quick_search_form_settings', true, true);
    ...
    {
        add_submenu_page($this->parentSlug, 'Quick Search Form', 'Quick Search Form', 'administrator', $this->slug,
            [$this, 'showQuickSearchForm']);
    }
}
