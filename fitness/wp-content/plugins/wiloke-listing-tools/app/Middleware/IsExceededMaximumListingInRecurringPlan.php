...
class IsExceededMaximumListingInRecurringPlan implements InterfaceMiddleware
{
    ...
    public function handle(array $aOptions)
    {
        ...
        if ($aOptions['aUserPlan']['remainingItems'] <= 0) {
            $this->msg =
                esc_html__('You have reached the maximum of availability listings in this plan. Please go to your Dashboard, then navigate to Billing and upgrade to higher plan.',
