...
class AlterTablePaymentHistory
{
     ...
     * @param token string If the session is progressed by PayPal method, token is generated by PayPal else it will be
     *                         generated by Wiloke System
     ...
     * @param created_at: When this post is created. This value will be updated as the customer click on Pay & Pushlic
     *                         button
     * @param updated_at: It's the same created_at at the first time and It will be updated at the next time, for
     *                         example, after the PayPal session is completed
     */
