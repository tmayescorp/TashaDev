...
return [
    'post_types'    => [
        ...
        'claim_listing' => [
            ...
            'rest_controller_class' => 'WP_REST_Posts_Controller',
            'rewrite'               => ['slug' => 'claim-listing', 'with_front' => false],
            'map_meta_cap'          => true,
            'supports'              => ['title']
        ],
        'listing_plan'  => [
            ...
            'rest_controller_class' => 'WP_REST_Posts_Controller',
            'rewrite'               => ['slug' => 'listing-plan', 'with_front' => false],
            'map_meta_cap'          => true,
        ...
        'discount'      => [
            ...
            'rest_base'             => 'discount',
            'rest_controller_class' => 'WP_REST_Posts_Controller',
            'rewrite'               => ['slug' => 'discount', 'with_front' => false],
            'map_meta_cap'          => true,
            'supports'              => ['title']
        ],
        'event'         => [
        ...
        'event_comment' => [
            ...
            'rest_controller_class' => 'WP_REST_Posts_Controller',
            'rewrite'               => ['slug' => 'event_comment', 'with_front' => false],
            'map_meta_cap'          => true,
        ...
        'promotion'     => [
            ...
            'rest_base'             => 'promotion',
            'rest_controller_class' => 'WP_REST_Posts_Controller',
            'rewrite'               => ['slug' => 'report', 'editor', 'with_front' => false],
            'map_meta_cap'          => true,
        ...
        'report'        => [
            ...
            'rest_base'             => 'report',
            'rest_controller_class' => 'WP_REST_Posts_Controller',
            'rewrite'               => ['slug' => 'report', 'with_front' => false],
            'map_meta_cap'          => true,
    ...
    'post_statuses' => [
        'unpaid'          => [
            ...
            'icon'                      => 'la la-money',
            'private'                   => true,
            'label_count'               => _n_noop('Unpaid <span class="count">(%s)</span>',
                'Unpaid <span class="count">(%s)</span>', 'wiloke-listing-tools'),
        ],
        'expired'         => [
            ...
            'label_count'               => _n_noop('Expired <span class="count">(%s)</span>',
                'Expired <span class="count">(%s)</span>', 'wiloke-listing-tools'),
        ],
        'temporary_close' => [
            ...
            'icon'                      => 'la la-refresh',
            'show_in_admin_status_list' => true,
            'label_count'               => _n_noop('Temporary close <span class="count">(%s)</span>',
                'Temporary close <span class="count">(%s)</span>', 'wiloke-listing-tools'),
        ],
        'editing'         => [
            ...
            'icon'                      => 'la la-refresh',
            'show_in_admin_status_list' => true,
            'label_count'               => _n_noop('Editing close <span class="count">(%s)</span>',
                'Temporary close <span class="count">(%s)</span>', 'wiloke-listing-tools'),
        ],
        'rejected'         => [
	        'label'                     => esc_html__('Rejected', 'wiloke-listing-tools'),
	        'public'                    => false,
	        'protected'                 => true,
	        'exclude_from_search'       => true,
	        'private'                   => true,
	        ...
	        'label_count'               => _n_noop('Rejected <span class="count">(%s)</span>',
		        'Rejected <span class="count">(%s)</span>', 'wiloke-listing-tools'),
        ]
    ]
];
