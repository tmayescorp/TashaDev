...
return [
    ...
    'settings' => [
        'general' => [
            'fields' => [
                [
                    'adminCategory' => 'wil-switch',
                    'label'         => 'Toggle Event Listing Type',
                    'key'           => 'toggle_event',
                    'valueFormat'   => 'String',
                    'std'           => 'enable',
                    'isDefault'     => true
                ...
                [
                    'adminCategory' => 'wil-switch',
                    'label'         => 'Is Immediately Approved?',
                    'key'           => 'immediately_approved',
                    'std'           => 'enable',
                    'valueFormat'   => 'String',
                    'isDefault'     => true
                ],
                [
                    'adminCategory' => 'wil-switch',
                    'label'         => 'Toggle Comment Discussion',
                    'key'           => 'toggle_comment_discussion',
                    'std'           => 'enable',
                    'valueFormat'   => 'String',
                    'isDefault'     => true
                ]
