...
return [
    ...
    'review_qualities'         => apply_filters('wilcity/wiloke-listing-tools/filter/review-qualities', [
        5  => [
            ...
            2 => esc_html__('Poor', 'wiloke-listing-tools'),
            1 => esc_html__('Terrible', 'wiloke-listing-tools')
        ],
        10 => [
        ...
        'parent'  => [
            ...
            'fields'       => [
                [
                    ...
                    'id'          => 'parent_id',
                    'name'        => 'Parent ID',
                    'default_cb'  => ['WilokeListingTools\MetaBoxes\Review', 'getParentID']
                ]
            ]
        ]
    ]
