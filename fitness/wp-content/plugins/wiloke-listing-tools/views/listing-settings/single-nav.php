    ...
    <div>
        <form id="wiloke-design-single-nav" method="post" action="#" class="ui form wiloke-review-claim-settings wiloke-form-has-icon">
            <div class="ui info message">
                <p>Refer to <a href="https://documentation.wilcity.com/knowledgebase/how-to-customize-single-directory-page/" target="_blank">Documentation</a> or Open a topic on <a href="https://wilcityservice.com/support/" target="_blank">wilcityservice.com/support/</a></p>
            </div>
        ...
        <?php do_action('wilcity/wiloke-listing-tools/wiloke-tools-settings', General::detectPostTypeSubmission() == 'wiloke-listing-settings' ? 'listing' : General::detectPostTypeSubmission(), str_replace('.php', '', basename(__FILE__))); ?>
    </div>
</div>
