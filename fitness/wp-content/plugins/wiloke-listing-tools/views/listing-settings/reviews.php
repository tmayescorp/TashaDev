			...
			<div class="field">
				...
				<div class="field">
					<div class="ui radio checkbox">
						<input type="radio" v-model="oReviewSettings.mode" :value="5">
						<label>Scale of 1 to 5</label>
					</div>
				</div>
				<div class="field">
					<div class="ui radio checkbox">
						<input type="radio" v-model="oReviewSettings.mode" :value="10">
							...
							<div class="dragArea__form-content">
								<div class="two fields">
									...
									<div class="field">
										...
										<i>This key must be unique and it does not contains special character</i>
									</div>
								</div>
							</div>
						</div>
