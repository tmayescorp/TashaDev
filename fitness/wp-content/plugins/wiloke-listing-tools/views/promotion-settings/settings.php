<div data-tab="settings" class="ui bottom attached tab active segment">
    ...
    <p class="ui message info"><a
            href="https://documentation.wilcity.com/knowledgebase/setting-up-promotion-in-wilcity/" target="_blank">Setting
            Up Promotion in Wilcity</a></p>
        ...
        <div v-show="toggle=='enable'">
            <div class="field">
                ...
                <div class="ui segment">
                    <p>
                        <strong style="color: #ff6657;">
                            Warning: Promotion ID isrequired If you are using listing_sidebar position.
                        </strong>
                    </p>
                    <p>
                        <strong style="color: #ff6657;">
                            If you won't use listing_sidebar, you can leave it for empty.
                        </strong>
                    </p>
                    <p>
                        <strong style="color: #ff6657;">
                            The promotion ID MUST BE unique and it SHOULD NOT contain special character like space,&,$ and it SHOULD NOT contain Uppercase Character.
                        </strong>
                    </p>
                    <p>
                        <strong style="color: #ff6657;">
                            This Promotion ID and Promotion ID under [Your directory
                            Type] Settings -> Single Sidebar -> Promotion must be the same.
                            EG: sidebar_1
                        </strong>
                    </p>
                </div>

                <draggable class="dragArea drag__used" v-model="aPlans"
                           :options="{handle: '.dragArea__form-title--icon'}">
                    <div v-for="(oPromotion, index) in aPlans" class="dragArea__block">
                        <div class="dragArea__form ui form field-wrapper segment">
                            <div class="dragArea__form-title">
                                ...
                                <span class="dragArea__form-title--remove" @click.prevent="removePlan(index, aPlans)"
                            ...
                            <div class="dragArea__form-content">
                                <div class="two fields">
                                    <div class="field">
                                        ...
                                        <p><i>Maxlength: 50 character. Please pay attention to Warning</i></p>
                                    </div>
                                    <div class="field">
                                    ...
                                    <div v-show="oPromotion.position=='listing_sidebar'" class="field">
                                        ...
                                        <select class="ui dropdown" v-model="oPromotion.conditional">
                                            <option v-for="(name, conditional) in aSingleListingConditionals"
                                                    :value="conditional">{{name}}
                                            </option>
                                        </select>
                                    </div>
                                    <div
                                        v-show="oPromotion.position=='listing_sidebar' && oPromotion.conditional=='google_address'"
                                        class="field">
                                        <label>Radius (*)</label>
                                ...
                                <select-from-post-types @changed="updateWooCommerceAssociate"
                                                        :value="oPromotion.productAssociation" post-types="product"
                                                        :index="index" is-multiple="no"
                                                        label="Associate with WooCommerce"></select-from-post-types>
                            </div>
                        </div>
                    </div>
                </draggable>
