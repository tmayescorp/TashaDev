    ...
    <form id="wiloke-claim-settings" method="post" action="#" class="ui form wiloke-review-claim-settings">
        ...
        <div>
            <div class="field">
                ...
                <p>When a user click on Claim Listing button, a Claim Information form will be shown. Here is the place
                    where you decide what fields will be displayed on the Claim Information form.</p>
                <draggable class="dragArea drag__used" v-model="oClaimFields"
                        ...
                        <div class="dragArea__form ui form field-wrapper segment">
                            <div class="dragArea__form-title">
                                ...
                                <span class="dragArea__form-title--remove"
                                    @click.prevent="removeClaimField(index, oField)" title="Remove Category">
                            ...
                            <div id="wilcity-claim-fields-wrapper" class="dragArea__form-content">
                                <div v-if="oField.type=='claimPackage'" class="ui message info">
                                    The claim packages are your listing plans. Go to Wiloke Submission -> Settings ->
                                    AddListing Plans to setup it.
                                </div>
                                ...
                                <div class="five fields">
                                    ...
                                    <div class="field">
                                        ...
                                        <select class="ui dropdown" v-model="oField.type"
                                            @change="changeClaimFieldType(oField, index)">
                                    ...
                                    <div v-show="oField.type == 'checkbox' || oField.type == 'radio'" class="field">
                                        ...
                                        <p><i>Each option is separated by a comma. For example: optiona:Option A,
                                                optionb:Option B</i></p>
                                    </div>
                                    <div class="field ui toggle checkbox"
                                        :class="{'checked': oField.isRequired=='yes'}">
                                        <input type="checkbox" v-model='oField.isRequired' true-value="yes"
                                            false-value="no">
