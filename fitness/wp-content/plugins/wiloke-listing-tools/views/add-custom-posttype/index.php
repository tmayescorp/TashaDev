<div id="wiloke-add-custom-posttypes">
    <!-- <h2 class="wiloke-add-listing-fields__title">Adding Listing Type</h2>
    <div class="message ui info">
        You can drag to re-order to Listing Type.
        The first Listing Type will be used as the default Listing Type.
    </div>
    <form id="wiloke-add-custom-posttypes" method="post" action="#" class="ui form wiloke-form-has-icon">
        ...
        <draggable v-model="oFields">
            <div v-for="(oField, index) in oFields" class="ui segment">
                <h4 class="ui dividing">Listing Type Settings</h4>
                <div class="fields six">
                    ...
                    <div class="field">
                        ...
                        <div><i>Do not show this Listing Type on the Add Listing page.</i></div>
                    </div>
        ...
        <div class="field">
            ...
            <button class="ui button basic purple" @click.prevent="addCustomPostType">Add Listing Type</button>
        </div>
    </form> -->
</div>
