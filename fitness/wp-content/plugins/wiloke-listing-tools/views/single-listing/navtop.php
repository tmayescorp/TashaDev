...
$aTabs = GetSettings::getPostMeta($post->ID, wilokeListingToolsRepository()->get('listing-settings:keys', true)->sub('navigation'));
    ...
    <div class="container">
        <nav class="detail-navtop_nav__1j1Ti">
            ...
            <ul class="list_module__1eis9 list-none list_horizontal__7fIr5">
                ...
                <li class="list_item__3YghP <?php echo esc_attr('wil-addlisting-left-tab-'.$aTab['key']); ?>">
