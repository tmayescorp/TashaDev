...
<p><strong><?php esc_html_e('Invoice ID', 'wiloke-listing-tools'); ?>
        :</strong> <?php echo esc_html($aInvoice['invoiceID']); ?></p>
<p><strong><?php esc_html_e('Invoice date', 'wiloke-listing-tools'); ?>
        :</strong> <?php echo date_i18n(get_option('date_format'), strtotime($aInvoice['created_at'])); ?></p>
...
<table width="100%">
    ...
    <tr>
        ...
        <td><?php echo GetWilokeSubmission::renderPrice($aInvoice['tax'], $aInvoice['currency']); ?></td>
