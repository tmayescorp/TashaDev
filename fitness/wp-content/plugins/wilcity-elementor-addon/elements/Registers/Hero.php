...
class Hero extends Widget_Base
{
	...
	protected function register_controls()
	{
		...
		$this->add_control(
			'custom_taxonomy_ids',
			[
				'label'       => 'Enter in Term IDs',
				'description' => 'Each term id is separated by a comma. For example: 1,2,3',
				'type'        => Controls_Manager::TEXT,
				'label_block' => true,
				'condition'   => [
					'taxonomy' => 'custom'
	...
	protected function render()
	{
		...
		$aSettings['image_bg']
			= isset($aSettings['image_bg']['id']) ? wp_get_attachment_image_url($aSettings['image_bg']['id'], 'large') :
			'';
