<div id="<?php use WilokeListingTools\Framework\Helpers\GetSettings;
use WilokeListingTools\Framework\Helpers\HTML;

echo esc_attr(apply_filters('wilcity/filter/id-prefix', 'wilcity-line-loading')); ?>" class="hidden line-loading_module__SUlA1 pos-a-top">
...
<div id="<?php echo esc_attr(apply_filters('wilcity/filter/id-prefix', 'wilcity-root')); ?>" class="page-wrap">
    ...
    do_action('wilcity/before-open-header-tag');
    ?>
    <!-- header_module__Snpib -->
    <header id="<?php echo esc_attr(apply_filters('wilcity/filter/id-prefix', 'wilcity-header-section')); ?>"
            class="header_module__Snpib js-header-sticky"
            data-header-theme="<?php echo esc_attr(apply_filters('wilcity/header/header-style', 'dark')); ?>"
            data-menu-color="<?php echo esc_attr(WilokeThemeOptions::getColor('general_menu_color')); ?>">
        ...
        <div class="wil-tb">
            ...
            if (class_exists('\WilokeListingTools\Framework\Helpers\GetSettings')) :
                ...
                if (!isset($aQuickSearchForm['toggle_quick_search_form']) || ($aQuickSearchForm['toggle_quick_search_form'] == 'yes')) : ?>
                    <div class="wil-tb__cell">
