...
?>
<div v-if="currentTab === 'listing-settings'" id="single-listing-settings"
     class="listing-settings listing-detail_body__287ZB <?php echo esc_attr(apply_filters('wilcity/filter/class-prefix',
         'wilcity-js-toggle-group')); ?>" data-tab-key="listing-settings">
    <div class="container">
        <div class="listing-detail_row__2UU6R clearfix">
            ...
            <wil-listing-settings :listing-settings="data.listingSettings"
                                  :post-id="<?php echo abs($post->ID); ?>"></wil-listing-settings>
