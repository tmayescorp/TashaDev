...
<header class="listing-detail_header__18Cfs hasSlider">
    ...
    <div
        ...
        data-options='{"autoplay": <?php echo json_encode(['delay' => abs($wiloke->aThemeOptions['listing_slider_autoplay'])]); ?>, "slidesPerView":1,"spaceBetween":4,"breakpoints":{"640":{"slidesPerView":1,"spaceBetween":4},"992":{"slidesPerView":2,"spaceBetween":4},"1200":{"slidesPerView":3,"spaceBetween":4},"1400":{"slidesPerView":3,"spaceBetween":4}}}'>
        <div class="swiper-wrapper">
            <?php foreach ($wilcityGallerySettings as $id => $url): ?>
                <div class="listing-detail_itemOverlay__1F_RJ">
                    <?php
                    $size = $wiloke->aThemeOptions['listing_featured_img_size'] ?? $wiloke->aThemeOptions['listing_slider_img_size'];
                    $imgUrl = wp_get_attachment_image_url($id, $size); ?>
                    <div class="listing-detail_sliderItem__3k2pH bg-cover"
                         style="background-image: url(<?php echo esc_attr($imgUrl); ?>);">
