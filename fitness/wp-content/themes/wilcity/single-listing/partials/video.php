...
if (!class_exists('WILCITY_SC\SCHelpers')) {
    return;
}
...
if (strpos($wilcityaVideo['src'], 'facebook.com') !== false) {
    ...
    $src = 'https://www.facebook.com/plugins/video.php?href=https%3A%2F%2Fwww.facebook.com%2Fvideo.php%3Fv%3D' . $src;
} else {
    ...
    <div class="gallery-item_module__1wn6T">
        ...
        <div class="video-popup_module__2P6ZG video-popup_sm__11-9c">
            <div class="video-popup_media__dEwwq">
                ...
                <a class="video-popup_popup__17b-F js-video-popup" href="<?php echo esc_url(SCHelpers::cleanYoutubeUrl($src)); ?>">
