...
if (empty($wilcityGallerySettings)) {
    $wilcityGallerySettings = [$headerBg];
} ?>
                            ...
                            <div class="bg-cover" style="background-image: url(<?php echo esc_url($imgUrl); ?>)">
                                <?php if (!empty($aGradientSettings)) : ?>
                                    <div class="gradient-color"
                                         style="background-image: linear-gradient(to top, <?php echo esc_attr($aGradientSettings['left']); ?> 7%, <?php echo esc_attr($aGradientSettings['right']); ?> 100%)"></div>
                                <?php endif; ?>
                            </div>
                        <?php endforeach; ?>
                    </div>
            ...
            <div class="row">
                <div class="col-md-12 col-lg-12 ">
                    <div class="utility-description_module__1mldF">
                        <p><?php Wiloke::ksesHTML(nl2br($oTerm->description)); ?></p>
                    </div>
                </div>
            </div>
        </div>
