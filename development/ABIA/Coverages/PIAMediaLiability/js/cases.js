...
/* Media*/
		...
		$('.nfl').click(function() {
			if ($("#ML img").hasClass('animated zoomIn')) {
				$("#ML img").removeClass('animated zoomIn');
			}
			if ($(".showimage").hasClass('animated zoomIn')) {
				$(".showimage").removeClass('animated zoomIn');

			}
			$('.nfl').attr('src', 'images/nflred.png').addClass('red animated zoomIn').fadeIn("slow");
			$('.1B').attr('src', 'images/1bilblk.png').addClass('').fadeIn("slow");
			$('.Albert').attr('src', 'images/albertblk.png').addClass('').fadeIn("slow");
			$('.36M').attr('src', 'images/36Mblk.png').addClass('').fadeIn("slow");
			$('.Webster').attr('src', 'images/webster.png').addClass('').fadeIn("slow");
			$('.show-text').html("<center>The US organization most sued for trademark infringement.</center>");
			$('.showimage').attr('src', 'images/nflanimated.gif').addClass('animated zoomIn').fadeIn("slow");
			$('.source').html("<strong>Source:</strong> : http://www.ipwatchdog.com/2017/12/05/2017-trademark-litigation-report-damages-awarded-default-judgment/id=90683");
		});
		...
		$('.1B').click(function() {
			...
			$('.nfl').attr('src', 'images/nflblk.png').addClass('').fadeIn("slow");
			$('.1B').attr('src', 'images/1bilred.png').addClass('red animated zoomIn').fadeIn("slow");
			$('.Albert').attr('src', 'images/albertblk.png').addClass('').fadeIn("slow");
			$('.36M').attr('src', 'images/36Mblk.png').addClass('').fadeIn("slow");
			$('.Webster').attr('src', 'images/webster.png').addClass('').fadeIn("slow");
			$('.show-text').html("<center>The amount of total damages awarded to Chanel from 2009-October 2017 for trademark infringement.</center>");
			$('.showimage').attr('src', 'images/bagmilanimated.gif').addClass('animated zoomIn').fadeIn("slow");
			$('.source').html("<strong>Source:</strong> http://www.ipwatchdog.com/2017/12/05/2017-trademark-litigation-report-damages-awarded-default-judgment/id=90683");
		});
		...
		$('.Albert').click(function() {
			...
			$('.nfl').attr('src', 'images/nflblk.png').addClass('').fadeIn("slow");
			$('.1B').attr('src', 'images/1bilblk.png').addClass('slow').fadeIn("slow");
			$('.Albert').attr('src', 'images/albertred.png').addClass('red animated zoomIn').fadeIn("slow");
			$('.36M').attr('src', 'images/36Mblk.png').addClass('').fadeIn("slow");
			$('.Webster').attr('src', 'images/webster.png').addClass('').fadeIn("slow");
			$('.show-text').html("<center>The subject of a commercial appropriation lawsuit brought against General Motors for an advertisement using  Mr. Einstein's face on a powerlifter’s body.</center>");
			$('.showimage').attr('src', 'images/emc2animated.gif').addClass('animated fadeIn').fadeIn("slow");
			$('.source').html("<strong>Source:</strong> https://www.michiganitlaw.com/right-of-publicity-individual");
		});
		...
		$('.36M').click(function() {
			...
			$('.1B').attr('src', 'images/1bilblk.png').addClass('slow').fadeIn("slow");
			$('.Albert').attr('src', 'images/albertblk.png').addClass('').fadeIn("slow");
			$('.36M').attr('src', 'images/36Mred.png').addClass('red animated zoomIn').fadeIn("slow");
			$('.Webster').attr('src', 'images/webster.png').addClass('').fadeIn("slow");
			$('.show-text').html("<center>The amount Rebel Wilson was awarded in a defamation case brought against Women’s Day magazine. </center>");
			$('.showimage').attr('src', 'images/3.6Manimated.gif').addClass('animated zoomIn').fadeIn("slow");
			$('.source').html("<strong>Source:</strong> http://www.businessinsider.com/rebel-wilson-just-won-a-staggering-46-million-in-a-defamation-case-2017-9");
		});
		$('.Webster').click(function() {
			if ($("#ML img").hasClass('animated zoomIn')) {
				$("#ML img").removeClass('animated zoomIn');
			}
			if ($(".showimage").hasClass('animated zoomIn')) {
			...
			$('.Albert').attr('src', 'images/albertblk.png').addClass('').fadeIn("slow");
			$('.36M').attr('src', 'images/36Mblk.png').addClass('').fadeIn("slow");
			$('.Webster').attr('src', 'images/websterred.png').addClass('red animated zoomIn').fadeIn("slow");
			$('.showimage').attr('src', 'images/slanderanimated.gif').addClass('animated zoomIn').fadeIn("slow");
			$('.show-text').html("<center>The internet blogger sued by Melania Trump for defamation.</center>");
			$('.source').html("<strong>Source:</strong> https://variety.com/2017/biz/news/melania-trump-defamation-webster-tarpley-1201980173/");
