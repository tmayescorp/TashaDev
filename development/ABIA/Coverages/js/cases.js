...
/*Ransomware */
		...
		$('.33blk').click(function() {
			...
			$('.show-text').html("<center>Ransomware hit 1/3 of small/medium businesses worldwide last year.</center>");
		...
		$('.59blk').click(function() {
			...
			$('.1077blk').attr('src', 'images/1077blk.png').addClass('').fadeIn("slow");
			$('.2daysblk').attr('src', 'images/2daysblk.png').addClass('').fadeIn("slow");
			$('.show-text').html("<ul class='rfft-list'><li>59% of ransomware attacks came through email.</li><li>You can still be a victim of ransomware even if yuo don't have <br>an online business.");
		...
		$('.1in5blk').click(function() {
			...
			$('.1077blk').attr('src', 'images/1077blk.png').addClass('').fadeIn("slow");
			$('.2daysblk').attr('src', 'images/2daysblk.png').addClass('').fadeIn("slow");
			$('.show-text').html("<ul class='rfft-list'><li>1 in 5 businesses that paid the ransom never got their files back.</li><li>Many businesses that paid the ransom were targeted again</li><li>Every situation needs to be evaluated with a cyber forensics expert.</li></ul>");
			$('.showimage').attr('src', 'images/1in5image.png').addClass('animated zoomIn').fadeIn("slow");
			$('.source').html("Source <br><a href='https://www.cyberscoop.com/ransomware-demands-now-average-1077-many-people-deciding-pay/' target='_blank'>https://www.cyberscoop.com/ransomware-demands-now-average-1077-many-people-deciding-pay/</a>");
		});
		...
		$('.2daysblk').click(function() {
			...
			$('.source').html("Source <br><a href='http://invenioit.com/security/ransomware-statistics-2016/' target='_blank'>http://invenioit.com/security/ransomware-statistics-2016/k</a>");
