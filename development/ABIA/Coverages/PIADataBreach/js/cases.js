...
/*Social Engineering*/
		...
		$('.600k').click(function() {
			if ($("#DB img").hasClass('animated zoomIn')) {
				$("#DB img").removeClass('animated zoomIn');
			}
			if ($(".showimage").hasClass('animated zoomIn')) {
				$(".showimage").removeClass('animated zoomIn');

			}
			$('.600k').attr('src', 'images/600kred.png').addClass('red animated zoomIn').fadeIn("slow");
			$('.170days').attr('src', 'images/170daysblk.png').addClass('').fadeIn("slow");
			$('.60percent').attr('src', 'images/60percentblk.png').addClass('').fadeIn("slow");
			$('.50').attr('src', 'images/50blk.png').addClass('').fadeIn("slow");
			$('.141').attr('src', 'images/141blk.png').addClass('').fadeIn("slow");
			$('.show-text').html("<center>600,000 Facebook accounts are compromised every day. Social media is a hacker’s favorite target.</center>");
			$('.showimage').attr('src', 'images/hackedanimated.gif').addClass('animated zoomIn').fadeIn("slow");
			$('.source').html("Source <br>https://heimdalsecurity.com/blog/10-surprising-cyber-security-facts-that-may-affect-your-online-safety/");
		});

		$('.170days').click(function() {
			if ($("#DB img").hasClass('animated zoomIn')) {
				$("#DB img").removeClass('animated zoomIn');
			}
			if ($(".showimage").hasClass('animated zoomIn')) {
			...
			$('.600k').attr('src', 'images/600kblk.png').addClass('').fadeIn("slow");
			$('.170days').attr('src', 'images/170daysred.png').addClass('red animated zoomIn').fadeIn("slow");
			$('.60percent').attr('src', 'images/60percentblk.png').addClass('').fadeIn("slow");
			$('.50').attr('src', 'images/50blk.png').addClass('').fadeIn("slow");
			$('.141').attr('src', 'images/141blk.png').addClass('').fadeIn("slow");
			$('.show-text').html("<center>It takes a average of 170 days to detect a malicious cyber attack.</center>");
			$('.showimage').attr('src', 'images/170days.png').addClass('animated zoomIn').fadeIn("slow");
			$('.source').html("Source <br>https://heimdalsecurity.com/blog/10-surprising-cyber-security-facts-that-may affect-your-online-safety/");

		});

		$('.60percent').click(function() {
			if ($("#DB img").hasClass('animated zoomIn')) {
				$("#DB img").removeClass('animated zoomIn');
			}
			if ($(".showimage").hasClass('animated zoomIn')) {
			...
			$('.600k').attr('src', 'images/600kblk.png').addClass('').fadeIn("slow");
			$('.170days').attr('src', 'images/170daysblk.png').addClass('').fadeIn("slow");
			$('.60percent').attr('src', 'images/60percentred.png').addClass('red animated zoomIn').fadeIn("slow");
			$('.50').attr('src', 'images/50blk.png').addClass('').fadeIn("slow");
			$('.141').attr('src', 'images/141blk.png').addClass('').fadeIn("slow");
			$('.show-text').html("<center>60% of attacks target small to medium-sized businesses.</center>");
			$('.showimage').attr('src', 'images/60percentanimated.png').addClass('animated fadeIn').fadeIn("slow");
			$('.source').html("Source: <br>https://www.nerdery.com/blog/cyber-security-data-breach-facts-at-a-glance-infographic");
		});
		...
		$('.50').click(function() {
			...
			$('.170days').attr('src', 'images/170daysblk.png').addClass('').fadeIn("slow");
			$('.60percent').attr('src', 'images/60percentblk.png').addClass('').fadeIn("slow");
			$('.50').attr('src', 'images/50red.png').addClass('red animated zoomIn').fadeIn("slow");
			$('.141').attr('src', 'images/141blk.png').addClass('').fadeIn("slow");
			$('.show-text').html("<center>All 50 states now have data breach notification laws.</center>");
			$('.showimage').attr('src', 'images/statesanimated.gif').addClass('animated zoomIn').fadeIn("slow");
			$('.source').html("Source <br>http://www.ncsl.org/research/telecommunications-and-information-technology/security-breach-notification-laws.aspx");
		...
		$('.141').click(function() {
			...
			$('.60percent').attr('src', 'images/60percentblk.png').addClass('').fadeIn("slow");
			$('.50').attr('src', 'images/50blk.png').addClass('').fadeIn("slow");
			$('.141').attr('src', 'images/141red.png').addClass('red animated zoomIn').fadeIn("slow");
			$('.showimage').attr('src', 'images/badgeanimated.gif').addClass('animated zoomIn').fadeIn("slow");
			$('.show-text').html("<center>The average cost of a data breach is $141 PER RECORD stolen.</center>");
			$('.source').html("Source <br>https://securityintelligence.com/media/2017-ponemon-institute-cost-of-a-data-breach-study/");
